...
go
	...
	--insert KHACHHANG
	INSERT INTO KHACHHANG VALUES ('KH01',N'Tony','0981215320');
	INSERT INTO KHACHHANG VALUES ('KH02',N'Carly','01235216354');
	INSERT INTO KHACHHANG VALUES ('KH03',N'Jenny','0971415201');
	INSERT INTO KHACHHANG VALUES ('KH04',N'Jack','0962135846');
	INSERT INTO KHACHHANG VALUES ('KH05',N'John','01652245125');
go
	--INSERT DICHVU
	INSERT INTO DICHVU VALUES ('DV01',N'Dịch vụ Quảng Cáo','200000');
	INSERT INTO DICHVU VALUES ('DV02',N'Dịch vụ Thiết Kế Banner','315000');
	INSERT INTO DICHVU VALUES ('DV03',N'Dịch vụ Marketing','170000');
	INSERT INTO DICHVU VALUES ('DV04',N'Dịch vụ Thiết Kế Slogan','480000');
	INSERT INTO DICHVU VALUES ('DV05',N'Dịch vụ Thiết Kế Thương Hiệu','532000');
go
...
--PROC BANG KHACH HANG
--Thêm dữ liệu bảng KHACHHANG
CREATE PROCEDURE ADD_KHACHHANG (@MAKH VARCHAR(8),@TENKH NVARCHAR(50),@DIENTHOAI VARCHAR(11))
AS
BEGIN
...
GO
	--Sua
CREATE PROCEDURE ALTER_KHACHHANG (@MAKH VARCHAR(8),@TENKH NVARCHAR(50),@DIENTHOAI VARCHAR(11))
AS
BEGIN
		UPDATE KHACHHANG
			SET TENKH = @TENKH,DIENTHOAI =@DIENTHOAI
			WHERE MAKH=@MAKH
	
	END
GO
	--Xóa
CREATE PROCEDURE D_KHACHHANG(@MAKH VARCHAR(8))
AS
	BEGIN
...
GO
--Proc DICHVU
--Thêm dữ liệu bảng DICHVU
CREATE PROCEDURE ADD_DICHVU (@MADV VARCHAR(8),@TENDV NVARCHAR(50),@GIA INT)
AS
BEGIN
...
GO
	--Sua
CREATE PROCEDURE ALTER_DICHVU (@MADV VARCHAR(8),@TENDV NVARCHAR(50),@GIA INT)
AS
BEGIN
		UPDATE DICHVU
...
GO
	--Xóa
CREATE PROCEDURE D_DICHVU(@MADV VARCHAR(8))
AS
	BEGIN
		DELETE FROM DICHVU
		WHERE MADV=@MADV
